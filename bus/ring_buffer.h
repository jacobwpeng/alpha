...
namespace alpha {
    class RingBuffer {
        ...
        public:
            ...
            static std::unique_ptr<RingBuffer> RestoreFrom(void * start, 
                    size_t len);
            static std::unique_ptr<RingBuffer> CreateFrom(void * start, 
                    size_t len);
        ...
        private:
            ...
            static const size_t kMaxBufferLength = kBufferHeaderLength 
                + kMaxBufferBodyLength;

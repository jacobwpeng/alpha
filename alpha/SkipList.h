 ...
 private:
  ...
  class IteratorBase {
   public:
    ...
    template <typename DerivedType2,
              ...
              typename Reference2>
    bool operator==(
        const IteratorBase<DerivedType2, ContainerType2, Pointer2, Reference2>&
            rhs) const;
    template <typename DerivedType2,
              typename ContainerType2,
              typename Pointer2,
  ...
  class ConstIterator
      : public std::iterator<std::bidirectional_iterator_tag, value_type>,
        public IteratorBase<ConstIterator,
                            const SkipList,
                            const value_type*,
                            const value_type&> {
   public:
...
template <typename Key, typename Value, int32_t kMaxLevel, typename Comparator>
bool SkipListType::NotGoBefore(const key_type& key,
                               NodeId node_id,
                               bool* equal) const {
  *equal = false;
  if (node_id == header_->tail) {

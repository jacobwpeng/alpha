...
class PingPongServerWorker : public alpha::Coroutine {
 public:
  ...
  void SetSlice(const Slice& data) { slice_ = data; }

  Slice GetSlice() const { return slice_; }

...
int main(int argc, char* argv[]) {
  ...
  std::unique_ptr<alpha::ProcessBus> bus(
      alpha::ProcessBus::RestoreOrCreate(filepath, kFileSize));
  ...
  size_t ms = std::chrono::duration_cast<std::chrono::milliseconds>(end - start)
                  .count();
